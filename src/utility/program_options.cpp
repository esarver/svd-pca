...
void ProgramOptions::print_help()
{
    //TODO UPDATE THIS!
    std::cout << std::endl;
    std::cout << " Usage: " << instance()->m_program_name << " [1|2|3|4] [pgm-file|pgm-header-file|SVD-compressed-file] [SVD-matrices-file] [approximation-rank]" << std::endl;
    std::cout << std::endl;
    std::cout << " Advance Algorithms Project #2: Image Compression Using SVD and Dimensionality Reduction Using PCA" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "                              Requires: pgm-header-file (ASCII), SVD-matrices-file, approximation-rank" << std::endl;
    ...
    std::cout << "                              Outputs:  pgm-header-file (ASCII), SVD-matrices-file, pgm-file (binary)" << std::endl;
    std::cout << std::endl;
    std::cout << " The following options are required as stated above:" << std::endl;
    std::cout << "    pgm-file (ASCII)     A textual PGM file conforming to the PGM P2 specification." << std::endl;
    std::cout << "    pgm-file (binary)    A binary PGM file conforming to the PGM P2 specification." << std::endl;
    std::cout << "    pgm-header-file      A text file containing the PGM P2 specification header (width height max-value)" << std::endl;
    std::cout << "    SVD-compressed-file  A file that has been approximated using SVD" << std::endl;
    std::cout << "    SVD-matrices-file    A file containing U, \u03A3, and V matrices" << std::endl;
    std::cout << "    approximation-rank   An integer representing the rank of the approximation." << std::endl;
    std::cout << std::endl;
    std::cout << std::endl;
    std::cout << " AUTHORS:" << std::endl;
    std::cout << "                       <     @zips.uakron.edu>" << std::endl;
    std::cout << "                       <      @zips.uakron.edu>" << std::endl;
